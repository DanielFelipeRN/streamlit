...
# 2. CSS avanzado para fijar la altura total y evitar desbordamientos
st.markdown("""
    <style>
        ...
        /* Bloquear scroll general de la página */
        .stApp {
        ...
        /* Contenedor maestro adaptado a la altura de la pantalla */
        .master-container {
...
with st.container():
    ...
    with col_camara:
        ...
        # Simulación de video con altura controlada para que no empuje el botón de abajo
        st.markdown(
            """
            <div style='background-color: #0e1117; height: 350px; display: flex; align-items: center; justify-content: center; color: #777; border-radius: 6px; font-size: 16px; border: 1px solid #333;'>
    ...
    with col_panel:
        ...
        # Contenedor dinámico de estados ajustado en tamaño
